...
app.config['MAIL_USERNAME'] = 'yourmailid@gmail.com'#put your eamil account
app.config['MAIL_PASSWORD'] = 'yourpassword' #put your email password
...
def sendmail():
    if request.method == 'POST':
        ...
        msg = Message('Hello', sender='yourmailid@gmail.com',recipients=[rec])
